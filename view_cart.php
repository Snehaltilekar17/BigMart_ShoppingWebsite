					...
					<table class='table table-striped table-bordered'>
						...
						<tbody>
							...
							<?php foreach ($items as $item): ?>
								<tr>
									<td><img src='./Added_imgs/img/<?php echo $item["img"]; ?>' style='height:80px;'></td>
									<td>
										<?php echo $item["name"]; ?>
									</td>
									<td>&#8377;
									...
									<td><input type='number' value='<?php echo $item["qty"]; ?>' class='qty'
											pid='<?php echo $item["id"]; ?>' min='1'></td>
									<td>&#8377; <span class='row_total'>
											<?php echo $item["total"]; ?>
										</span></td>
									<td><a href='remove.php?id=<?php echo $item["id"]; ?>'
						...
						<tfoot>
							<tr>
								<td colspan='3'><a href='Product_1.php' class="btn btn-success">Continue Shopping</a></td>
								<th>Total</th>
								<th>&#8377; <span id='total'>
