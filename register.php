...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO register(Name,email,mob,uname,pass,confpass,date) VALUES ('$name','$email','$mob','$Username','$password','$confPassword',Now())";
                    ...
                    <div class="card card-login mb-5">
                        <div class="card-body">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-group row mt-3">
                                    <div class="col-md-12">
                                        <input class="form-control" type="tel" required="" placeholder="Phone"
                                            name="mob">
                                    </div>
                                </div>
                                <div class="form-group row mt-3">
